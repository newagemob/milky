...
export function MilkySmokeScreenR3F() {
  ...
  },
  {
    id: "milky-hillside",
    name: "Milky Hillside",
    description: "A cosmic waving gaseous hillside.",
    tags: ["shader", "hillside", "wave", "gradient", "cosmic", "animation"],
    thumbnail: "/thumbnails/milky-hillside.jpg",
    component: MilkyHillsideR3F,
    code: `"use client"
